...
/***/ function(module, exports, __webpack_require__) {
	...
	var SessionTable = __webpack_require__(161);
	
	var sessions = [{ title: 'Broadford S1', track: 'Broadford', date: '10/04/2016', bestTime: '1:05.7' }, { title: 'Broadford S2', track: 'Broadford', date: '10/04/2016', bestTime: '1:04.7' }, { title: 'Broadford S3', track: 'Broadford', date: '10/04/2016', bestTime: '1:03.2' }, { title: 'Broadford S4', track: 'Broadford', date: '10/04/2016', bestTime: '1:03.7' }, { title: 'Broadford S5', track: 'Broadford', date: '10/04/2016', bestTime: '1:04.1' }, { title: 'Broadford S6', track: 'Broadford', date: '10/04/2016', bestTime: '1:03.9' }];
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-10' },
						React.createElement(SessionTable, { sessions: sessions })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SessionRow = __webpack_require__(162);
	
	var React = __webpack_require__(2);
	
	var SessionTable = React.createClass({
	  displayName: 'SessionTable',
	
	  render: function render() {
	    var rows = [];
	    this.props.sessions.forEach(function (session) {
	      rows.push(React.createElement(SessionRow, { session: session, key: session.name }));
	    }.bind(this));
	    return React.createElement(
	      'table',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'td',
	        null,
	        this.props.session.track
	      ),
	      React.createElement(
	        'td',
	        null,
	        this.props.session.bestTime
	      )
	    );
	  }
	});
